...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    // { id: '5e65c167f292590db6b78f9e', iat: 1583726952, exp: 1591502952 }
...
exports.restrictTo = (...roles) => {
    return (req, res, next) => {
        ...
        if(!roles.includes(req.user.role)) {
            return next(
                new AppError('Yon do not have permission to perform this action', 403)
            )
        }
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    ...
    // 4) Log user in, send JWT send JWT
    createSendToken(user, 200, res);
});